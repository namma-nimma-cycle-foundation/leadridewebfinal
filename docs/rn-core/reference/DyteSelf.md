...
Enable a preview for audio and video. This will populate preview.audioTrack and
preview.videoTrack. You can check if the streams are enabled in the preview
