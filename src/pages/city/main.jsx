...
"url('https://images.unsplash.com/photo-1452830978618-d6feae7d0ffa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=512&q=80')",
  ...
  <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-blue-600 dark:text-white">Building happy and healthy cities <br></br> </h1>
                <p className="max-w-2xl mb-6 font-light text-gray-700 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-700">Lead ride aims to transform your relationship with people and cities by cycling together. 
                 Lead Ride connects critical stakeholders in the ecosystem and enables active mobility by multiple interventions . 
                  </p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.87c1.355 0 2.697.055 4.024.165C17.155 8.51 18 9.473 18 10.608v2.513m-3-4.87v-1.5m-6 1.5v-1.5m12 9.75l-1.5.75a3.354 3.354 0 01-3 0 3.354 3.354 0 00-3 0 3.354 3.354 0 01-3 0 3.354 3.354 0 00-3 0 3.354 3.354 0 01-3 0L3 16.5m15-3.38a48.474 48.474 0 00-6-.37c-2.032 0-4.034.125-6 .37m12 0c.39.049.777.102 1.163.16 1.07.16 1.837 1.094 1.837 2.175v5.17c0 .62-.504 1.124-1.125 1.124H4.125A1.125 1.125 0 013 20.625v-5.17c0-1.08.768-2.014 1.837-2.174A47.78 47.78 0 016 13.12M12.265 3.11a.375.375 0 11-.53 0L12 2.845l.265.265zm-3 0a.375.375 0 11-.53 0L9 2.845l.265.265zm6 0a.375.375 0 11-.53 0L15 2.845l.265.265z" />
        ...
        <div className="px-5 sm:px-10 md:px-20 lg:px-10 xl:px-20 py-8 bg-gray-100" id="cards">
          <div className="max-w-screen-xl mx-auto">
            <h3 className="leading-none font-black text-3xl">Lead Ride City - Structure</h3>
            ...
            <div className="lg:flex justify-between lg:mt-8">
              <div className="lg:mx-2 flex flex-col items-center">
                <div className="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                  <div className="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                    <div className="text-lg font-bold text-gray-700 leading-tight">Structure</div>
                    <div>
                      <div className="flex justify-between mt-6 text-xs font-bold">
                        <div className="flex items-start">
                          ...
                          <span className="ml-1 text-gray-500">City Champions</span>
                        </div>
                        ...
                        <div className="flex items-start ml-4">
                          ...
                          <span className="ml-1 text-gray-500">Consortium</span>
                        </div>
                      </div>
                      <div className="text-center flex flex-row justify-between flex-wrap justify-between items-center text-xs font-bold">
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-green-200 text-green-600">Buddy Network</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-indigo-200 text-indigo-600"> Stakeholders</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600">City Leadership</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-purple-200 text-purple-600">Lead Ride team </span>
                      </div>
                      <div className="mt-12 flex items-center">
                        <div className="w-16 h-16 bg-cover rounded-full border-2 border-gray-700" alt="" ></div>
                        <div className="ml-5">
                          <div className="font-bold text-gray-800">
                            Enable active mobility
                          </div>
                          <div className="text-xs text-gray-500">by cycling together</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="lg:mx-2 flex flex-col items-center">
                <div className="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                  <div className="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                    <div className="text-lg font-bold text-gray-700 leading-tight">Delivery</div>
                    <div>
                      <div className="flex justify-between mt-6 text-xs font-bold">
                        <div className="flex items-start">
                          <svg className="text-gray-400 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <span className="ml-1 text-gray-500">Your city</span>
                        </div>
                        ...
                        <div className="flex items-start ml-4">
                          ...
                          <span className="ml-1 text-gray-500">World Cycle Day June 3 </span>
                        </div>
                      </div>
                      <div className="text-center flex flex-row justify-between flex-wrap justify-between items-center text-xs font-bold">
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-yellow-200 text-yellow-600">Communication </span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-indigo-200 text-indigo-600">Information</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600"> Operation </span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-purple-200 text-purple-600">Experiences</span>
                      </div>
                      <div className="mt-12 flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-xs text-gray-500">Bicycle Momentum - begin the movement</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="lg:mx-2 flex flex-col items-center">
                <div className="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                  <div className="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                    <div className="text-lg font-bold text-gray-700 leading-tight">Design  Events & Spaces</div>
                    <div>
                      <div className="flex justify-between mt-6 text-xs font-bold">
                        <div className="flex items-start">
                          <svg className="text-gray-400 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="flex items-start ml-4">
                          ...
                          <span className="ml-1 text-gray-500">Branding </span>
                        </div>
                      </div>
                      <div className="text-center flex flex-row justify-between flex-wrap justify-between items-center text-xs font-bold">
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-yellow-200 text-yellow-600">Participatory Design</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-indigo-200 text-indigo-600">Human Centered Design</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600">  Place Making</span>
                        <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-purple-200 text-purple-600">Active Mobility Integration </span>
                      </div>
                      <div className="mt-12 flex items-center">
                        <div className="w-16 h-16 bg-cover rounded-full border-2 border-gray-700" alt=""
                                                                                              ></div>
                        <div className="ml-4">
                          ...
                          <div className="text-xs text-gray-500">Transforming Spaces by collective intelligence</div>
                        </div>
                      </div>
                    </div>
                  </div>
