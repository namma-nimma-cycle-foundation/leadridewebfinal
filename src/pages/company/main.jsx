    ...
    >
      <div>
            ...
            <section className="bg-white dark:bg-gray-900">
              <div className="grid max-w-screen-xl px-4 pt-20 pb-3 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-18">
                <div className="mr-auto place-self-center lg:col-span-7">
                  ...
                  Enhance Workforce Performance &   Wellbeing  <br></br>{" "}
                  </h1>
                  <h1 className="max-w-2xl mb-4 text-2xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-4xl text-blue-600 dark:text-white">
                    Take care of your people <br></br>{" "}
                  </h1>
                  <p className="max-w-2xl mb-6 font-light text-gray-700 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-700">
                  Fostering mind, body, and heart connection for a  more resilient workforce and improved well-being in the workplace                  </p>
        ...
        */}
            ...
            <div className="px-5 sm:px-3 md:px-3 lg:px-3 xl:px-3 py-8 bg-blue-300"  id="features">
              <div className="max-w-screen-xl mx-auto">
                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white"> 
                 Lead Ride for Corporate  <br></br> How it works </h1>
            ...
            <div
              className="px-5 sm:px-10 md:px-20 lg:px-10 xl:px-20 py-8 bg-orange-400"
              id="blog-posts"
            >
              <div className="max-w-screen-xl mx-auto">
                <div className="xl:flex">
                  <div>
                    <h3 className="leading-none font-black text-3xl">
                      Lead Ride Corporate - A Catalyst
                    </h3>
                    Cycling Together to make employees productive and meaningful.
                      ...
                      >
                        <div className="transition-all duration-300 cursor-pointer w-full shadow-lg hover:shadow-xl rounded-lg bg-gray-100 relative">
                          ...
                          <div className="p-6">
                            ...
                            Employees  will be significantly improving the health and fitness
                            </div>
                          </div>
                        </div>
                      </a>
                        ...
                        <div className="transition-all duration-300 cursor-pointer w-full shadow-lg hover:shadow-xl rounded-lg bg-gray-100 relative">
                          ...
                          <div className="p-6">
                            ...
                            <div className="mt-2 text-gray-900 text-sm">
                              ...
                              Enhance the branding of the company - measure and mitigate emission within the company.
                            </div>
                          </div>
                        </div>
                      </a>
                    ...
                    bg-gray-100 relative xl:flex xl:flex-row-reverse xl:items-center xl:px-6 xl:py-8"
                        >
                          ...
                          <div className="p-6 xl:p-0">
                            ...
                            <div className="mt-2 text-gray-900 text-sm ">
                              Ride together to enable place making.
                            </div>
                          </div>
                        </div>
                      </a>
                    ...
                    bg-gray-100 relative xl:flex xl:flex-row-reverse xl:items-center xl:px-6 xl:py-8"
                        >
                          ...
                          <div className="p-6 xl:p-0">
                            ...
                            <div className="mt-2 text-gray-900 text-sm  ">
                               Make your company a better connected hub for people to thrive.
                            </div>
                          </div>
                        </div>
                      </a>
