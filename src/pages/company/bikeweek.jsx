...
export const Feature = () => {
  return (
    ...
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">Explore our Awesome 
        <span className="text-blue-500">Components</span></h1>
