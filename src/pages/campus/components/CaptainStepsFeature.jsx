...
export default function CaptainStepsFeature() {
   
  
    return (
		 
      <div className=" px-4  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-14 lg:px-8 lg:py-20">
        <section className=" bg-yellow-300 dark:bg-gray-800 dark:text-gray-100">
	<div className="container mx-auto flex flex-col p-6">
		<h2 className="py-4 text-3xl font-bold text-center">Steps to Get Started as a Lead Ride Captain
</h2>
		<div className="divide-y divide-gray-700">
			...
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:text-violet-400">Step 4 - Become part </span>
					<span className="text-xl font-bold md:text-2xl">Get Involved</span>
					<span className="mt-4 dark:text-gray-300">  Get involved in an activity with your Lead Ride B-Well Club!.</span>
				</div>
			</div>
		</div>
	</div>
